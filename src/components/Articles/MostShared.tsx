    ...
    <div>
      <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        {articles.map((post) => (
          <article
            key={post.id}
            className="flex flex-col items-start hover:ease-linear justify-between transform transition-transform hover:scale-1  hover:rounded-2xl hover:p-1 hover:shadow-xl"
          >
